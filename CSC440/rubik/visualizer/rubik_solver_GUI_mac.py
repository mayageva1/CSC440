...
###############################################
    ...
    def fill_cell_properties(self, button, x, y):
        ...
        i = x % 2 + y % 2 * 2
        button["highlightbackground"]  = self.getColor(self.faces[face][i])
...
############ GUI COMPONENTS ############
    ...
    def create_rubik(self, f):
        self.btnUp = Button(f, image=self.imgBlank, borderwidth=0, command=self.btnArrow_clicked, highlightbackground="#E2E2E2")
        ...
        labelTop = Label(f, text="Top", width=5, height=3, highlightbackground="#E2E2E2")
        labelTop.grid(row=1,column=2)

        labelBottom = Label(f, text="Down", width=5, height=3, highlightbackground="#E2E2E2")
        labelBottom.grid(row=6,column=2)

        labelLeft = Label(f, text="Left", width=5, height=3, anchor=S, highlightbackground="#E2E2E2")
        labelLeft.grid(row=2,column=1)

        labelRight = Label(f, text="Right", width=5, height=3, anchor=S, highlightbackground="#E2E2E2")
        labelRight.grid(row=2,column=6)

        labelBack = Label(f, text="Back", width=5, height=3, anchor=S, highlightbackground="#E2E2E2")
        labelBack.grid(row=2,column=8)

        self.btnLogo = Button(f, image=self.imgRubik, borderwidth=0, anchor=W, command=self.btnLogo_clicked, highlightbackground="#E2E2E2")
        self.btnLogo.grid(row=6, column=5)


        self.btnDown = Button(f, image=self.imgBlank, borderwidth=0, command=self.btnArrow_clicked, highlightbackground="#E2E2E2")
        self.btnDown.grid(row=7, column=3)

        self.btnLeft = Button(f, image=self.imgBlank, borderwidth=0, command=self.btnArrow_clicked, highlightbackground="#E2E2E2")
        self.btnLeft.grid(row=3, column=0)

        self.btnRight = Button(f, image=self.imgBlank, borderwidth=0, command=self.btnArrow_clicked, highlightbackground="#E2E2E2")
        self.btnRight.grid(row=3, column=9)

        self.btnTurn270 = Button(f, image=self.imgBlank, borderwidth=0, command=self.btnArrow_clicked, highlightbackground="#E2E2E2")
        self.btnTurn270.grid(row=2, column=2)

        self.btnTurn0 = Button(f, image=self.imgBlank, borderwidth=0, command=self.btnArrow_clicked, highlightbackground="#E2E2E2")
        self.btnTurn0.grid(row=2, column=5)

        self.btnTurn90 = Button(f, image=self.imgBlank, borderwidth=0, command=self.btnArrow_clicked, highlightbackground="#E2E2E2")
        self.btnTurn90.grid(row=5, column=5)

        self.btnTurn180 = Button(f, image=self.imgBlank, borderwidth=0, command=self.btnArrow_clicked, highlightbackground="#E2E2E2")
    ...
    def update_cell(self, btn):
        ...
        self.fill_cell_properties(btn, self.faces_pos[face][0] + index % 2, self.faces_pos[face][1] + int(index / 2))
    ...
    def create_color_picker(self, f):
        self.label = Label(f,text="Pick colors to edit the cube:", highlightbackground="#FFFFFF")
    ...
    def create_controller(self, f):
        ...
        self.lblInfo = Label(f, highlightbackground="#000000")
    ...
    def show_sol_controllers(self):
        ...
        self.sol_left["highlightbackground"] = "#000000"
        self.sol_left["text"] = "<"

        self.sol_right["borderwidth"] = 1;
        self.sol_right["highlightbackground"] = "#000000"
        self.sol_right["text"] = ">"
    ...
    def hide_sol_controllers(self):
        self.sol_left["borderwidth"] = 0;
        self.sol_left["highlightbackground"] = self.step_buttons[0]["highlightbackground"]
        self.sol_left["text"] = ""

        self.sol_right["borderwidth"] = 0;
        self.sol_right["highlightbackground"] = self.step_buttons[0]["highlightbackground"]
        self.sol_right["text"] = ""
...
################### MOUSE ACTION ###################
    def btnColor_clicked(self, event):
        if (len(self.steps) == 0):
            ...
            self.current_color_selection = event.widget["highlightbackground"]
        else:
...
################### INIT ###################
    def __init__(self, root):
        ...
        root["highlightbackground"] = highlightbackground="#E2E2E2"
        self.initialize_images()

        self.reset_rubik()

        fColor = Frame(root, height=75, width=830, highlightbackground="#FFFFFF")
        fColor.pack_propagate(0)
        fColor.pack()
        self.create_color_picker(fColor)

        fRubik = Frame(root, height=400, width=830, highlightbackground="#E2E2E2")
        ...
        fController = Frame(root, height=60, width=830, highlightbackground="#FFFFFF")
